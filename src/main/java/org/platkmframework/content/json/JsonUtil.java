	...
	*/
	public static void init() {
                    ...
                    public LocalDate deserialize(JsonElement je, java.lang.reflect.Type type,
                    	...
                    	if (StringUtils.isNotBlank(je.getAsJsonPrimitive().getAsString())) {
                            return LocalDate.parse(
                                    ...
                                    DateTimeFormatter.ofPattern(ProjectContent.instance().getDateFormat()));
                        } else {
                            return null;
                        }
                    }
                    ...
                    public JsonElement serialize(LocalDateTime t, java.lang.reflect.Type type,
                        ...
                        if (t != null) {
                            DateTimeFormatter dateTimeFormatter = DateTimeFormatter
                                    .ofPattern(ProjectContent.instance().getDateTimeFormat());
                            return new JsonPrimitive(t.format(dateTimeFormatter));
                        } else {
                            return null;
                        }
        ...
        .registerTypeAdapter(LocalDateTime.class, (JsonDeserializer<LocalDateTime>) (JsonElement je,
            ...
            if (StringUtils.isNotBlank(je.getAsJsonPrimitive().getAsString())) {
                return LocalDateTime.parse(je.getAsJsonPrimitive().getAsString().trim(),
                        DateTimeFormatter.ofPattern(ProjectContent.instance().getDateTimeFormat()));
            } else {
                return null;
            }
        })
        ...
        .registerTypeAdapter(LocalTime.class,
                (JsonSerializer<LocalTime>) new JsonSerializer<LocalTime>() {
                    ...
                    public JsonElement serialize(LocalTime t, java.lang.reflect.Type type,
                        ...
                        if (t != null) {
                            DateTimeFormatter dateTimeFormatter = DateTimeFormatter
                                    .ofPattern(ProjectContent.instance().getTimeFormat());
                            return new JsonPrimitive(t.format(dateTimeFormatter));
                        } else {
                            return null;
                        }
        ...
        .registerTypeAdapter(LocalTime.class, (JsonDeserializer<LocalTime>) (JsonElement je,
            ...
            if (je.getAsJsonPrimitive().getAsString() != null) {
                return LocalTime.parse(je.getAsJsonPrimitive().getAsString().trim(),
                        DateTimeFormatter.ofPattern(ProjectContent.instance().getTimeFormat()));
            } else {
                return null;
            }
        })
        .registerTypeAdapter(Timestamp.class,
                (JsonSerializer<Timestamp>) new JsonSerializer<Timestamp>() {

                    @Override
                    public JsonElement serialize(Timestamp t, java.lang.reflect.Type type,
                            JsonSerializationContext jsc) {
                        if (t != null) {
                            DateTimeFormatter dateTimeFormatter = DateTimeFormatter
                                    .ofPattern(ProjectContent.instance().getDateTimeFormat());
        ...
        .registerTypeAdapter(Timestamp.class, (JsonDeserializer<Timestamp>) (JsonElement je,
                java.lang.reflect.Type type, JsonDeserializationContext jdc) -> {
            if (je.getAsJsonPrimitive().getAsString() != null) {
